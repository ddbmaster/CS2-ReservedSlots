...
{
    [JsonPropertyName("Reserved Flags")] 
    public List<string> reservedFlags { get; set; } = new() 
    { 
        "@css/vip", 
        "76561198012345678",  // Beispiel SteamID64
        "76561198087654321"   // Beispiel SteamID64
    };

    [JsonPropertyName("Admin Reserved Flags")] 
    public List<string> adminFlags { get; set; } = new() 
    { 
        "@css/admin", 
        "@css/ban" 
    };

    [JsonPropertyName("Reserved Slots")] 
    public int reservedSlots { get; set; } = 2;

    [JsonPropertyName("Reserved Slots Method")] 
    public int reservedSlotsMethod { get; set; } = 0;

    [JsonPropertyName("Leave One Slot Open")] 
    public bool openSlot { get; set; } = false;

    [JsonPropertyName("Kick Immunity Type")] 
    public int kickImmunity { get; set; } = 0;

    [JsonPropertyName("Kick Reason")] 
    public int kickReason { get; set; } = 135;

    [JsonPropertyName("Kick Delay")] 
    public int kickDelay { get; set; } = 5;

    [JsonPropertyName("Kick Check Method")] 
    public int kickCheckMethod { get; set; } = 0;

    [JsonPropertyName("Kick Type")] 
    public int kickType { get; set; } = 0;

    [JsonPropertyName("Kick Players In Spectate")] 
    public bool kickPlayersInSpectate { get; set; } = true;

    [JsonPropertyName("Log Kicked Players")] 
    public bool logKickedPlayers { get; set; } = true;

    [JsonPropertyName("Display Kicked Players Message")] 
    public int displayKickedPlayers { get; set; } = 2;
}
